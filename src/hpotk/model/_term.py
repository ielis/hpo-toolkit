...
class MinimalTerm(Identified, Named, metaclass=abc.ABCMeta):
    ...
    * `is_obsolete` - the *obsoletion status*
    ...
    @staticmethod
    def create_minimal_term(
        term_id: typing.Union[TermId, str],
        name: str,
