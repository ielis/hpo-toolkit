...
class TestGetParents:
    ...
    def test_get_parents__base_graph(self, base_graph: OntologyGraph, source, expected):
...
class TestGetAncestors:
    ...
    def test_base_graph(self, base_graph: OntologyGraph, source, expected):
...
class TestIsLeaf:
    ...
    def test_base_graph(self, base_graph: OntologyGraph, query, expected):
...
class TestOntologyGraphQueries:
    ...
    def test_is_parent_of_or_equal_to(
        ...
        assert (
            base_graph.is_parent_of_or_equal_to(
                sub,
                obj,
            )
            is expected
    ...
    def test_is_ancestor_of_or_equal_to(
        ...
        assert (
            base_graph.is_ancestor_of_or_equal_to(
                sub,
                obj,
            )
            is expected
    ...
    def test_is_child_of_or_equal_to(
        ...
        assert (
            base_graph.is_child_of_or_equal_to(
                sub,
                obj,
            )
            is expected
    ...
    def test_is_descendant_of_or_equal_to(
        ...
        assert (
            base_graph.is_descendant_of_or_equal_to(
                sub,
                obj,
            )
            is expected
...
class TestCsrOntologyGraph(unittest.TestCase):
    ...
    def test_graph_queries_work_with_identified(self):
        # tests
        self.assertTrue(
            self.GRAPH.is_ancestor_of(
                SimpleIdentified.from_curie("HP:01"),
                SimpleIdentified.from_curie("HP:0110"),
            )
        )
        self.assertTrue(
            self.GRAPH.is_parent_of(
                SimpleIdentified.from_curie("HP:01"),
                SimpleIdentified.from_curie("HP:010"),
            )
        )
        self.assertTrue(
            self.GRAPH.is_child_of(
                SimpleIdentified.from_curie("HP:01"),
                SimpleIdentified.from_curie("HP:1"),
            )
        )
        self.assertTrue(
            self.GRAPH.is_descendant_of(
                SimpleIdentified.from_curie("HP:01"),
                SimpleIdentified.from_curie("HP:1"),
            )
        )
        ...
        # traversal
        self.assertSetEqual(
            set(self.GRAPH.get_ancestors(SimpleIdentified.from_curie("HP:010"))),
            {hpotk.TermId.from_curie("HP:01"), hpotk.TermId.from_curie("HP:1")},
        )
        self.assertSetEqual(
            set(self.GRAPH.get_parents(SimpleIdentified.from_curie("HP:01"))),
            {hpotk.TermId.from_curie("HP:1")},
        )
        self.assertSetEqual(
            set(self.GRAPH.get_children(SimpleIdentified.from_curie("HP:01"))),
            {hpotk.TermId.from_curie("HP:010"), hpotk.TermId.from_curie("HP:011")},
        )
        self.assertSetEqual(
            set(self.GRAPH.get_descendants(SimpleIdentified.from_curie("HP:01"))),
            {
    ...
    def test_graph_queries_work_with_str(self):
        ...
        self.assertSetEqual(
            set(self.GRAPH.get_descendants("HP:01")),
            {
                hpotk.TermId.from_curie("HP:010"),
                hpotk.TermId.from_curie("HP:011"),
                hpotk.TermId.from_curie("HP:0110"),
