...
class TestMinimalTerm:
    ...
    def test_equal_terms_are_equal(self):
        ...
        other = MinimalTerm.create_minimal_term(
            TermId.from_curie("HP:1234567"),
            "First",
            [TermId.from_curie("HP:1111111")],
            False,
...
class TestTerm:
    ...
    def test_equal_terms_are_equal(self):
        ...
        one_syn = Synonym(
            ...
            None,
            [TermId.from_curie("ORCID:1234-5678-1234-5678")],
        )
        one = Term.create_term(
            identifier=one_id,
            name="First",
            ...
            synonyms=[one_syn],
            xrefs=[TermId.from_curie("SNOMED_CT:123456")],
        )
        two_id = TermId.from_curie("HP:1234567")
        two = Term.create_term(
            identifier=two_id,
            name="First",
            alt_term_ids=[TermId.from_curie("HP:1111111")],
            is_obsolete=False,
