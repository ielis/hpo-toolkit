...
class TestResnik:
    ...
    def test_precalculate_and_store(
        self,
        small_hpo: hpotk.MinimalOntology,
    ...
    def test_calculate_ic_for_hpo_diseases(
        self,
        small_hpo: hpotk.MinimalOntology,
        toy_hpoa: HpoDiseases,
    ):
        ...
        expected = {
            ...
            "HP:0000001": 0.0,  # All
            "HP:0000118": 0.0,  # Phenotypic abnormality
    ...
    def test_calculate_ic_for_hpo_diseases__use_pseudocount(
        self,
        small_hpo: hpotk.MinimalOntology,
        toy_hpoa: HpoDiseases,
    ):
    ...
    def test_calculate_ic_for_hpo_diseases__submodule(
        self,
        small_hpo: hpotk.MinimalOntology,
        toy_hpoa: HpoDiseases,
    ):
    ...
    def test_calculate_ic_for_hpo_diseases__submodule_and_use_pseudocount(
        self,
        small_hpo: hpotk.MinimalOntology,
        toy_hpoa: HpoDiseases,
    ):
    ...
    @pytest.mark.skip("Skipped for now")
    def test_precalculate_mica_for_hpo_concept_pairs(
        self,
        small_hpo: hpotk.MinimalOntology,
        toy_hpoa: HpoDiseases,
    ):
